    ...
    <div class="mx-[147px] pt-[82px]">
        <div class="flex items-center flex-row justify-between">
            ...
            <div class=" shadow-md mr-20 rounded-full  shadow-black">
                <img class="" src="images/btn-add.svg" alt="">
            </div>
        </div>
        ...
        <div class="w-full h-[270px]  mt-3 rounded-[30px] z-20 shadow-md bg-white">
            <div class="flex flex-row justify-around items-center pt-6">
                <div
                    class="ring-1 ring-[#142F64] w-[106px] text-sm h-[27px] rounded-full flex justify-center items-center">
                    <h1 class="text-[#142F64] font-medium">Semester 1</h1>
                </div>
                <div class="w-[925px] fill-[#DADADA]">
            ...
            <div class="swiper px-[34px] mySwiper">
